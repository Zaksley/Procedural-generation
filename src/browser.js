...
function showTextureOptions(value) {
    ...
    setTimeout(() => {
        ...
        switch (value) {
            ...
            case "gameOfLife":                      options = ["step", "config"]; break;
            case "greenbergHastings":               options = ["step", "color1", "color2", "color3"]; break;
            ...
            case "sdCircle":                        options = ["function", "size", "centerx", "centery", "color1"]; break;
            case "sdBox":                           options = ["function", "size", "size2", "centerx", "centery", "color1"]; break;
            case "sdRoundedBox":                    options = ["function", "size", "size2", "size3", "centerx", "centery", "color1"]; break;
            case "sdOrientedBox":                   options = ["function", "size", "size2", "fullangle", "centerx", "centery", "color1"]; break;
            case "sdSegment":                       options = ["function", "size", "size2", "fullangle", "centerx", "centery", "color1"]; break;
            case "sdRhombus":                       options = ["function", "size", "size2", "centerx", "centery", "color1"]; break;
            case "sdIsoscelesTrapezoid":            options = ["function", "size", "size2", "size3", "centerx", "centery", "color1"]; break;
            case "sdParallelogram":                 options = ["function", "size", "size2", "distance", "centerx", "centery", "color1"]; break;
            case "sdEquilateralTriangle":           options = ["function", "size", "centerx", "centery", "color1"]; break;
            case "sdIsoscelesTriangle":             options = ["function", "size", "size2", "centerx", "centery", "color1"]; break;
            case "sdTriangle":                      options = ["function", "color1"]; break;
            case "sdUnevenCapsule":                 options = ["function", "size", "size2", "size3", "centerx", "centery", "color1"]; break;
            case "sdRegularPentagon":               options = ["function", "size", "centerx", "centery", "color1"]; break;
            case "sdRegularHexagon":                options = ["function", "size", "centerx", "centery", "color1"]; break;
            case "sdRegularOctogon":                options = ["function", "size", "centerx", "centery", "color1"]; break;
            case "sdHexagram":                      options = ["function", "size", "centerx", "centery", "color1"]; break;
            case "sdStar5":                         options = ["function", "size", "size2", "centerx", "centery", "color1"]; break;
            case "sdRegularStar":                   options = ["function", "size", "branches", "branches2", "centerx", "centery", "color1"]; break;
            case "sdPie":                           options = ["function", "size", "fullangle", "centerx", "centery", "color1"]; break;
            case "sdArc":                           options = ["function", "size", "size2", "fullangle", "fullangle2", "centerx", "centery", "color1"]; break;
            case "sdHorseshoe":                     options = ["function", "size", "size2", "size3", "fullangle", "centerx", "centery", "color1"]; break;
            case "sdVesica":                        options = ["function", "size", "size2", "distance", "centerx", "centery", "color1"]; break;
            case "sdMoon":                          options = ["function", "size", "size2", "size3", "centerx", "centery", "color1"]; break;
            case "sdSimpleEgg":                     options = ["function", "size", "size2", "centerx", "centery", "color1"]; break;
            case "sdHeart":                         options = ["function", "size", "centerx", "centery", "color1"]; break;
            case "sdCross":                         options = ["function", "size", "size2", "size3", "centerx", "centery", "color1"]; break;
            case "sdCircleCross":                   options = ["function", "size", "centerx", "centery", "color1"]; break;
            case "sdBobblyCross":                   options = ["function", "size", "centerx", "centery", "color1"]; break;
            case "sdRoundedX":                      options = ["function", "size", "size2", "centerx", "centery", "color1"]; break;
            case "sdPolygon":                       options = ["function", "branches", "color1"]; break;
            case "sdEllipse":                       options = ["function", "size", "size2", "centerx", "centery", "color1"]; break;
            case "sdParabola":                      options = ["function", "size", "centerx", "centery", "color1"]; break;
            case "sdParabolaSegment":               options = ["function", "size", "size2", "centerx", "centery", "color1"]; break;
            case "sdQuadraticBezier":               options = ["function", "color1"]; break;

            // Animations todo
            case "chromaticCircle":     window.ANIMATION = true; options = ["size", "color1", "centerx", "centery"]; break;
            case "Yinyang":             window.ANIMATION = true; options = ["size", "centerx", "centery", "color1", "color2", "color3"]; break;
            ...
            case "GreenbergHastings":   window.ANIMATION = true; options = ["color1", "color2", "color3"]; break;
